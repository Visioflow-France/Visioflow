...
function formValidateStep2(){
  ...
  const filled = allItems.filter(function(it){ return it.name&&it.name.trim()&&it.price&&it.price.trim(); });
  if(filled.length === 0){
    formShowError('Ajoutez au moins un plat avec un nom et un prix dans le menu.');
    return false;
  }
