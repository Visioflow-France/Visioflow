    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          #vflp .article-title{font-family:'Fraunces',sans-serif;font-size:20px;font-weight:600;color:#f1f5f9;margin:24px 0 12px;padding-left:12px;border-left:3px solid #0071E3}
          ...
          #vflp .price-table th{background:rgba(0,113,227,.15);color:#f1f5f9;padding:16px;text-align:left;font-weight:600;border-bottom:1px solid rgba(0,113,227,.2)}
          #vflp .price-table td{padding:16px;color:#94a3b8;border-bottom:1px solid rgba(255,255,255,.05)}
