    ...
    <>
      <Head>
        ...
        <style>{`
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          .data-table{width:100%;border-collapse:collapse;margin:20px 0;background:rgba(0,113,227,.05);border-radius:12px;overflow:hidden}
          .data-table th{background:rgba(0,113,227,.15);color:#f1f5f9;padding:16px;text-align:left;font-weight:600;border-bottom:1px solid rgba(0,113,227,.2)}
          .data-table td{padding:16px;color:#94a3b8;border-bottom:1px solid rgba(255,255,255,.05)}
          ...
          @media(max-width:768px){.nav-links{display:none}.data-table{font-size:13px}.data-table th,.data-table td{padding:12px}}
        `}</style>
      </Head>
      ...
      <div className="container content">
        ...
        <div className="section">
          ...
          <h3 style={{fontFamily:'Outfit, sans-serif',fontSize:'18px',fontWeight:700,color:'#f1f5f9',margin:'24px 0 16px'}}>1. Données collectées lors de la création de compte</h3>
          <p>
          ...
          <h3 style={{fontFamily:'Outfit, sans-serif',fontSize:'18px',fontWeight:700,color:'#f1f5f9',margin:'24px 0 16px'}}>4. Données collectées via les cookies</h3>
          <p>
